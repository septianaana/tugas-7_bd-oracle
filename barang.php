              ...
              <form class="form-horizontal" action="add_barang.php" method="post">
               <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="JUMLAH_BARANG" placeholder="JUMLAH_BARANG">
                </div>
                <div class="form-group col-md-6">
                  <label for="">HARGA</label>
                  <input type="text" class="form-control" name="HARGA_BARANG" placeholder="HARGA_BARANG">
                </div> 
